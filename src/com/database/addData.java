...
public class addData {
	...
	public static void addExecutiveAccount() throws SQLException {
		...
		Executive executive = new Executive(executivName, executivUserName, executivAge, executivAddress, executivCity,
				executivState, executivPassword);

		if (addData.addExecutive(executive)) {
			System.out.println("Executive creation initiated " + "successfully");
		}
	}
